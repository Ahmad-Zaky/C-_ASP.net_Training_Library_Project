...
{
    public partial class Book_Publisher : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                conn.Open();
                string str = "select name_author from Author ";
                ...
                if (rdr.HasRows)
                {
                    while (rdr.Read())
                    {
                        ...
                        DropDownList1.Items.Add(rdr["name_author"].ToString());
                    }
        ...
        protected void DropDownList1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            string str = " select id from Author where name_author = '" + x + "'";
            ...
            if (rdr.HasRows)
            {
                while (rdr.Read())
                {
                    ...
                    id_author.Text = rdr.GetInt32(0).ToString();
                }
            ...
            string str2 = "select id_book from Author_Book where id_author = '" + id_author.Text + "'";
